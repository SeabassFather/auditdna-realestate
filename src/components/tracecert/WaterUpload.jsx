...
/**
 * WaterUpload Component - Upload and manage water test results
 */
const WaterUpload = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow">
      <h3 className="text-xl font-bold text-gray-800 mb-4">Water Test Upload</h3>
      ...
      >
        {uploading ? 'Uploading...' : 'Upload Water Test Results'}
      </button>
    </div>
  );
};
