  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        {/* ==================== PARTNERS TAB - LIFESTYLE PARTNERS ==================== */}
        {activeTab === "partners" && (
          <section style={{ position: 'relative' }}>
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              {/* ========== LIFESTYLE PARTNERS - FEATURED SPOTLIGHT ========== */}
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                        <button
                          onClick={() => {
                            const msg = language === 'english' 
                              ? 'Hello, I\'m interested in U4RIK Spirits - private tasting inquiry from EnjoyBaja.com'
                              : 'Hola, estoy interesado en U4RIK Spirits - consulta de degustación privada desde EnjoyBaja.com';
                            window.open(`https://wa.me/526463402686?text=${encodeURIComponent(msg)}`, '_blank');
                          }}
                          style={{
                            padding: '14px 32px',
                        ...
                        >
                          {language === 'english' ? 'PRIVATE TASTINGS' : 'DEGUSTACIONES'}
                        </button>
                        <button
                          onClick={() => {
                            const msg = language === 'english' 
                              ? 'Hello, wholesale inquiry for U4RIK Spirits from EnjoyBaja.com'
                              : 'Hola, consulta mayorista para U4RIK Spirits desde EnjoyBaja.com';
                            window.open(`https://wa.me/526463402686?text=${encodeURIComponent(msg)}`, '_blank');
                          }}
                          style={{
                            padding: '14px 32px',
              ...
              <div style={{ textAlign: 'center', marginBottom: '48px' }}>
                <p style={{ 
                  ...
                  {language === 'english' ? 'FOR DISTINGUISHED BRANDS' : 'PARA MARCAS DISTINGUIDAS'}
                </p>
                <h3 style={{ 
