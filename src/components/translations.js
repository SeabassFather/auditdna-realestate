export const translations = {
  en: {
    homepageTitle: "AuditDNA Produce Platform",
    homepageSub: "Powered by Advanced AI Technology",
    produceDashboard: "Produce Dashboard",
    produceDesc: "Analytics, pricing, market data",
    usdaDashboard: "USDA Intelligence",
    usdaDesc: "Multi-commodity, compliance, exports",
    traceDashboard: "Traceability AI Hub",
    traceDesc: "Chain of custody, QR, AI analysis",
    waterDashboard: "WaterTech",
    waterDesc: "Lab, compliance, test uploads",
    factoringDashboard: "Ag Factoring",
