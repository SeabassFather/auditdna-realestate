...
import { emailProperty, printProperty, downloadPDF } from '../utils/propertyActions';
...
export default function MexicoRealEstate() {
  ...
  const territories = [
    ...
    'La Paz', 'Cabo San Lucas', 'San Jose del Cabo', 'Todos Santos', 'Los Barriles',
    'Puerto Vallarta', 'Sayulita', 'Mazatlan',
    'Tulum', 'Playa del Carmen', 'Cancún', 'Akumal',
    'San Miguel de Allende', 'Mérida', 'Oaxaca', 'Mexico City', 'Queretaro'
  ];
  ...
  const properties = [
    ...
    {
      id: 5,
      title: 'Colonial Hacienda - Mérida',
      territory: 'Mérida',
      price: 675000,
      beds: 6,
      baths: 5,
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #334155 100%)' }}>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gap: '24px', marginBottom: '60px' }}>
              {[
                ...
                { step: '6', days: '1 day', title: 'Closing Day', tasks: ['Sign final documents', 'Transfer funds to escrow', 'Notario registers deed', 'Receive keys'], docs: ['Escritura Pública', 'Payment proof', 'Registration receipt'] },
        ...
        {activeTab === 'notario' && (
          <div>
            <h3 style={{ fontSize: '32px', fontWeight: '300', color: '#cba658', marginBottom: '40px' }}>Understanding the Notario Público</h3>
            ...
            <div style={{ background: 'rgba(15, 23, 42, 0.4)', border: '1px solid rgba(203, 166, 88, 0.2)', borderRadius: '12px', padding: '32px', marginBottom: '40px' }}>
              <h4 style={{ fontSize: '24px', fontWeight: '600', color: '#f1f5f9', marginBottom: '20px' }}>What is a Notario Público?</h4>
              <p style={{ fontSize: '15px', color: '#cbd5e1', lineHeight: '1.8', marginBottom: '16px' }}>In Mexico, a Notario Público is NOT just a notary public. They are licensed attorneys appointed by the state government who serve as public officials. Think of them as a combination of an attorney, title company, and notary all in one.</p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px', marginBottom: '40px' }}>
              {['Verify legal capacity of buyer and seller','Conduct thorough title search','Confirm property has no liens','Calculate all transfer taxes','Draft the Escritura Pública (deed)','Witness signing of documents','Register deed with Public Registry','Provide certified copies','Archive documents 100+ years'].map((item, idx) => (
                <div key={idx} style={{ display: 'flex', alignItems: 'start', gap: '12px', padding: '16px', background: 'rgba(203, 166, 88, 0.05)', borderRadius: '8px' }}>
                  <span style={{ color: '#cba658', fontSize: '20px' }}>✓</span>
            ...
            <div style={{ display: 'grid', gap: '16px', marginBottom: '40px' }}>
              {[
                ...
                { step: '6', title: 'Deed Execution', desc: 'All parties sign Escritura Pública' },
        ...
        {activeTab === 'agents' && (
          <div>
            ...
            <div style={{ textAlign: 'center', marginBottom: '48px' }}>
              <button onClick={() => navigate('/agent-login')} style={{ padding: '20px 60px', background: 'linear-gradient(135deg, #cba658, #b8944d)', color: '#0f172a', border: 'none', borderRadius: '12px', fontSize: '18px', fontWeight: '700', cursor: 'pointer', boxShadow: '0 4px 12px rgba(203, 166, 88, 0.3)' }}>Agent Login / Register →</button>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '30px', marginBottom: '40px' }}>
              ...
              <div style={{ background: 'rgba(15, 23, 42, 0.4)', border: '1px solid rgba(203, 166, 88, 0.2)', borderRadius: '12px', padding: '32px' }}>
                <h4 style={{ fontSize: '22px', fontWeight: '600', color: '#cba658', marginBottom: '20px' }}>💰 Commission Structure</h4>
            ...
            <div style={{ background: 'rgba(15, 23, 42, 0.4)', border: '1px solid rgba(203, 166, 88, 0.2)', borderRadius: '12px', padding: '32px', marginBottom: '40px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
                {[
                  ...
                  { icon: '💬', title: 'Lead Management', desc: 'Buyer inquiries & follow-ups' },
                  { icon: '📸', title: 'Photo Manager', desc: 'Upload & organize images' },
                  { icon: '📝', title: 'Listing Editor', desc: 'Update prices & details' },
                  { icon: '📅', title: 'Scheduling', desc: 'Showing appointments' },
                  { icon: '💵', title: 'Commission Tracker', desc: 'Earnings & payments' }
                ].map((feature, idx) => (
            ...
            <div style={{ background: 'rgba(34, 197, 94, 0.1)', border: '1px solid rgba(34, 197, 94, 0.3)', borderRadius: '12px', padding: '32px' }}>
              <h4 style={{ fontSize: '22px', fontWeight: '600', color: '#86efac', marginBottom: '16px' }}>✨ Premium Agent Benefits</h4>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
