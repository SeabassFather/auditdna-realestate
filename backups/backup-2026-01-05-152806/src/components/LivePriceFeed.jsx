...
import { getLivePrices } from "../api/priceFeed";
import { io } from "socket.io-client";

export default function LivePriceFeed({ zone = "all" }) {
  ...
  return (
    <div style={{ background:'#1e293b', padding:24, borderRadius:12, color:'#10b981', maxWidth:600, margin:"0 auto" }}>
