  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a' }}>
      <div style={{ position: 'absolute', top: '20px', right: '20px', display: 'flex', gap: '12px' }}>
        ...
        <button onClick={() => navigate('/login')} style={{
          padding: '10px 20px', background: 'rgba(203, 166, 88, 0.1)',
          border: '1px solid rgba(203, 166, 88, 0.3)', borderRadius: '6px',
          color: '#cba658', fontWeight: '600', cursor: 'pointer'
        }}>
          Admin Login
        </button>
      </div>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '80px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
          <div onClick={() => navigate('/mexico-real-estate')} style={{
            background: 'rgba(15, 23, 42, 0.6)', border: '2px solid #94a3b8',
            borderRadius: '4px', padding: '48px 32px', cursor: 'pointer', transition: 'all 0.2s'
          }}
          onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#cbd5e1'; e.currentTarget.style.background = 'rgba(30, 41, 59, 0.6)'; }}
          onMouseLeave={(e) => { e.currentTarget.style.borderColor = '#94a3b8'; e.currentTarget.style.background = 'rgba(15, 23, 42, 0.6)'; }}>
          ...
          onMouseLeave={(e) => { e.currentTarget.style.borderColor = '#94a3b8'; e.currentTarget.style.background = 'rgba(15, 23, 42, 0.6)'; }}>
            ...
            <p style={{ fontSize: '14px', color: '#94a3b8', lineHeight: '1.6', marginBottom: '24px', fontWeight: '300' }}>
              Mortgage financing for US properties (Purchase & Refinance)
            </p>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontSize: '13px', fontWeight: '600', color: '#60a5fa' }}>
  ...
  return (
    <LanguageProvider>
      ...
      <Routes>
        ...
        <Route path="/agent-upload" element={<ProtectedRoute><AgentPropertyUpload /></ProtectedRoute>} />
