...
const { testConnection } = require('../services/Email_service');
...
// ── Shared SMTP config — single source of truth ──────────────
...
// ── Re-export transactional email functions ───────────────────
const { sendRegistrationEmail, sendAuditCompleteEmail, sendOTPEmail } = require('../services/Email_service');
module.exports = router;
module.exports.sendRegistrationEmail = sendRegistrationEmail;
module.exports.sendAuditCompleteEmail = sendAuditCompleteEmail;
